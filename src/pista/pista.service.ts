    ...
    */
        ...
        public modificarPista(id:number, body:any):any{
                ...
                if (id=== this.listaPistas[i].identificador){
                        existe = true;
                        pos = i;
                }
                }
                if(existe){
                this.listaPistas[pos].duracion = body.duracion;
                this.listaPistas[pos].titulo = body.titulo;
                this.listaPistas[pos].interprete = body.interprete;
                return {              
                    "msj": `Pista ${id} modificada`,
                    "Pista":this.listaPistas[pos]
                }
